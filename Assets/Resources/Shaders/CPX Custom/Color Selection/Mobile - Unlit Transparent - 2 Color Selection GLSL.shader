Shader "CPX_Custom/Mobile/Color Selection/Unlit Transparent - 2 Color Selection GLSL" {
   Properties {
   ...
   Fallback "CPX_Custom/Mobile/Color Selection/Unlit Transparent - 2 Color Selection CG"
}