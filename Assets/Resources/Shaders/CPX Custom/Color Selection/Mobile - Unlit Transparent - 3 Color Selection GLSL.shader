Shader "CPX_Custom/Mobile/Color Selection/Unlit Transparent - 3 Color Selection GLSL" {
   Properties {
  ...
  SubShader {
      ...
      Pass {  
         ...
         uniform lowp vec4 _Color1, _Color2, _Color3;
   ...
   Fallback "CPX_Custom/Mobile/Color Selection/Unlit Transparent - 3 Color Selection CG"
}