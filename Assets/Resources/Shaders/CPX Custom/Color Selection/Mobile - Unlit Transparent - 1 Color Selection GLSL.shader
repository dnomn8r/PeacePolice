Shader "CPX_Custom/Mobile/Color Selection/Unlit Transparent - 1 Color Selection GLSL" {
   Properties {
   ...
   Fallback "CPX_Custom/Mobile/Color Selection/Unlit Transparent - 1 Color Selection CG"
}