Shader "CPX_Custom/Mobile/Color Selection/Rim/Unlit Texture - 3 Color Selection GLSL" {
   Properties {
   ...
   SubShader {
      Pass {    
         ...
         uniform lowp vec4 _Color1, _Color2, _Color3, _RimColor, _RimDirection;
   ...
   Fallback "CPX_Custom/Mobile/Color Selection/Unlit Texture - 3 Color Selection CG"
}